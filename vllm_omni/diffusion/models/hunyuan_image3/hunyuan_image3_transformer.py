...
# ResBlock is platform-dispatched (see blocks.py): CUDA gets fused GroupNorm+SiLU
# and AdaGN kernels, every other backend gets the plain PyTorch block. UNetDown
# and UNetUp below instantiate whichever one this resolves to.
from vllm_omni.diffusion.models.hunyuan_image3.blocks import ResBlock
