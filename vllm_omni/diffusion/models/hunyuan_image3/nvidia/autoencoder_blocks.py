...
This variant deliberately uses plain ``nn.Conv3d`` instead of the chunked
``Conv3d`` from the default module: cuDNN handles the full tensor, so the
temporal chunking only gets in the way.
"""
